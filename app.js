...
function messageRows() {
  ...
  if (!messages.length) {
    ...
    html += '<div class="row them"><div class="bubble them">This is a small AI chat project built to respond in a Jamie-like style. You can ask questions, try a conversation, or log in to keep previous chats.</div></div>';
  }
